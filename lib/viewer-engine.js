...
import { is3d, walkPoseFromHit, walkClickIntent, commentHotkeyBlocked, explodeVec, explodePos, verticalExplodeY, clampFov } from './format.js';
...
export class ViewerEngine {
  ...
  drawMarkers() {
    ...
    this.comments.forEach((c, i) => {
      if (c.kind === 'pdf' || c.pos_x == null) return;
  ...
  drawSvgMarkers() {
    ...
    this.comments.forEach((c, i) => { if (c.kind !== 'pdf' && c.pos_x != null) mk(i + 1, c.pos_x, c.pos_y, '#0474E0', i); });
